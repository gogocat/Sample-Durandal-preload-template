/**
 * Updated by Adam Chow - adamchow2326@yahoo.com.au
 * Added detect if template already on page before do ajax call
 * check script type="text/html" with data-view-path="myview/path"  
 * @require jQuery
 *
